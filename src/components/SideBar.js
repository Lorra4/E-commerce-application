  ...
  return (
    <div className="sideBarContainer">
      <div className="sideBarButtons">
        <button className="myAppsBtn sideBarMainButtons forPadding">
          <svg
        ...
        {sectionList.map((section, index) => (
          <button key={index} className="sectionButton sideBarMainButtons">
        ...
        <button className="sideBarMainButtons forPadding">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
            viewBox="0 0 448 512"
        ...
        {/* <button
          className="sideBarMainButtons add"
          onClick={() => setIsAppAdd(true)}
        >
          <span>add apps</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
